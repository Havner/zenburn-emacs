...
;;;;; helm
   ...
   `(helm-buffer-not-saved ((t (:foreground ,zenburn-red :background ,zenburn-bg :weight bold))))
   `(helm-buffer-modified ((t (:foreground ,zenburn-green :background ,zenburn-bg :weight bold))))
   ...
   `(helm-buffer-directory ((t (:foreground ,zenburn-blue :background ,zenburn-bg))))
   `(helm-ff-directory ((t (:foreground ,zenburn-cyan :background ,zenburn-bg :weight bold))))
   `(helm-ff-dotted-directory ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg))))
   ...
   `(helm-ff-dotted-symlink-directory ((t (:foreground ,zenburn-yellow-1 :background ,zenburn-bg :weight bold))))
...
;;;;; whitespace-mode
   ...
   `(whitespace-hspace ((t (:foreground ,zenburn-bg+3))))
...
;;;;; rtags
   `(rtags-argument-face ((t (:foreground ,zenburn-fg :background ,zenburn-green-1))))
;;;;; symbol-overlay
   `(symbol-overlay-default-face ((t (:background ,zenburn-bg-1))))
   `(symbol-overlay-face-1 ((t (:background ,zenburn-cyan    :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-2 ((t (:background ,zenburn-green+4 :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-3 ((t (:background ,zenburn-magenta :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-4 ((t (:background ,zenburn-yellow  :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-5 ((t (:background ,zenburn-red     :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-6 ((t (:background ,zenburn-orange  :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-7 ((t (:background ,zenburn-red-2   :foreground ,zenburn-bg-1))))
   `(symbol-overlay-face-8 ((t (:background ,zenburn-green   :foreground ,zenburn-bg-1))))
;;;;; lsp-ui
   `(lsp-ui-sideline-global ((t (:background ,zenburn-bg-1))))
   `(lsp-ui-sideline-code-action ((t (:foreground ,zenburn-yellow-2))))
;;;;; cquery
   `(cquery-inactive-region-face ((t (:background ,zenburn-bg-1 :inherit shadow))))
   ))
